...
function downloadQpm(octokit, token) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (!artifact) {
      core.error(
        `No artifact found for ${const_1.QPM_REPOSITORY_OWNER}/${const_1.QPM_REPOSITORY_NAME}@${const_1.QPM_REPOSITORY_BRANCH} `
      )
    }
...
function run() {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      const cachePathOutput = (0, strip_ansi_1.default)(
        (yield (0, utils_1.githubExecAsync)(`${qpmRustPath} ${const_1.QPM_COMMAND_CACHE_PATH}`)).stdout
      )
      let paths = []
      let cacheKey
      const key = 'qpm-cache-'
