...
function doPublish(octokit, release, debug, qmod, version, tag) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const download = (0, utils_1.getReleaseDownloadLink)(
      github.context.repo.owner,
      github.context.repo.repo,
      tag !== null && tag !== void 0 ? tag : version
    )
    ...
    if (debug) {
      ...
      const name =
        (_c = (_b = additionalData.overrideDebugSoName) !== null && _b !== void 0 ? _b : nameOverride) !== null &&
        _c !== void 0
          ? _c
          : debugVersionedName
    ...
    yield core.group('Publish', () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const lastCommit = yield git.getCommit(
          Object.assign(Object.assign({}, github.context.repo), { commit_sha: lastCommitSha })
        )
        try {
        ...
        // create commit
        const newTree = yield git.createTree(
          Object.assign(Object.assign({}, github.context.repo), {
            tree: [
              {
        ...
        const commit = yield git.createCommit(
          Object.assign(Object.assign({}, github.context.repo), {
        ...
        yield git.updateRef(
          Object.assign(Object.assign({}, github.context.repo), { ref: branchHead, sha: commit.data.sha, force: true })
        )
      })
    )
    // do github stuff
...
function publishRun(params) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    yield (0, utils_1.githubExecAsync)(
      `qpm ${const_1.QPM_COMMAND_PUBLISH} "${publishToken !== null && publishToken !== void 0 ? publishToken : ''}"`
    )
  })
}
