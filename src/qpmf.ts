...
export async function readQPM(file: fs.PathOrFileDescriptor): Promise<QPMPackage | QPMSharedPackage> {
...
export async function writeQPM(file: fs.PathOrFileDescriptor, qpm: QPMPackage | QPMSharedPackage): Promise<void> {
